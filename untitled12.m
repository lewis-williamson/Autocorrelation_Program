...
for i=1:12
    paths{i}=append('/Users/lewis/Documents/phd/experiments/inline_autocorrelation/03_11_23/microscope_data/',num2str(2*(i-1)),'k/Results.txt')
    
end 

for i=1:length(paths)
   results{i}= extraction(paths{i}) 
end 
...
% function [averages]=averaging(tab_index,tab)
% 
%     raw_data=cell2mat(tab{tab_index})


    
function [data]=extraction(filename)
